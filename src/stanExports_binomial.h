...
static constexpr std::array<const char*, 13> locations_array__ =
  ...
  " (in 'binomial', line 8, column 5 to column 35)",
  " (in 'binomial', line 9, column 5 to column 35)",
  " (in 'binomial', line 18, column 5 to column 33)",
  " (in 'binomial', line 19, column 5 to column 33)",
  " (in 'binomial', line 12, column 5 to column 31)",
  " (in 'binomial', line 13, column 5 to column 31)",
  " (in 'binomial', line 14, column 5 to column 25)",
  " (in 'binomial', line 15, column 5 to column 25)",
  " (in 'binomial', line 2, column 5 to column 21)",
  " (in 'binomial', line 3, column 5 to column 21)",
  " (in 'binomial', line 4, column 5 to column 31)",
  " (in 'binomial', line 5, column 5 to column 31)"};
...
public:
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    try {
      ...
      theta2 = in__.template read_constrain_lub<local_scalar_t__,
                 jacobian__>(0, 1, lp__);
      {
        current_statement__ = 5;
        lp_accum__.add(stan::math::binomial_lpmf<propto__>(y1, N1, theta1));
        current_statement__ = 6;
        lp_accum__.add(stan::math::binomial_lpmf<propto__>(y2, N2, theta2));
        current_statement__ = 7;
        lp_accum__.add(stan::math::beta_lpdf<propto__>(theta1, 1, 1));
        current_statement__ = 8;
        lp_accum__.add(stan::math::beta_lpdf<propto__>(theta2, 1, 1));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    try {
      ...
      prob = stan::math::logical_gt(theta2, theta1);
      out__.write(lift);
      out__.write(prob);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
  ...
  unconstrain_array_impl(const VecVar& params_r__, const VecI& params_i__,
    ...
    try {
      ...
      out__.write_free_lub(0, 1, theta2);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  }
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    if (emit_generated_quantities__) {
      std::vector<std::string> temp{"lift", "prob"};
  ...
  constrained_param_names(std::vector<std::string>& param_names__, bool
    ...
    if (emit_transformed_parameters__) {}
    if (emit_generated_quantities__) {
      param_names__.emplace_back(std::string() + "lift");
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"theta1\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"theta2\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"lift\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"prob\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
  }
